				...
				<div class="col-sm-9">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<p>
								<b>Título Original :</b> ${ pelicula.titulo } <br> <b>Actores
									:</b> ${  pelicula.detalle.actores } <br> <b>Director: </b>${ pelicula.detalle.director }
								<br> <b>Clasificación:</b> ${ pelicula.clasificacion } <br>
								<b>Duración: </b>${ pelicula.duracion  } minutos<br> <b>Género:
								</b>${ pelicula.genero } <br> <b>Fecha Estreno:</b>
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">
						<span class="label label-success"> ${ fechaBusqueda } </span>
					</h3>
				</div>
				<div class="panel-body">
