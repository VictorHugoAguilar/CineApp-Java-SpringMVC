...
<body>
	...
	<div class="container theme-showcase" role="main">
		...
		<form:form class="form-horizontal" method="post"
			action="${urlRoot}contacto" modelAttribute="contacto">
			...
			<div class="form-group">
				<label for="genero" class="col-sm-2 control-label">Géneros
					Favoritos</label>
				<div class="col-sm-10">
					<form:select path="generos" id="genero" name="generos"
						multiple="multiple" class="form-control" items="${generos}" />
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<form:checkboxes items="${notifications}" path="notificaciones" />
