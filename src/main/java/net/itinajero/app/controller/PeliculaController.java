...
public class PeliculaController {
	...
	@PostMapping("/save")
	public String guardar(@ModelAttribute Pelicula pelicula, BindingResult result, RedirectAttributes redirectAttibute,
			@RequestParam("archivoImagen") MultipartFile multiPart, HttpServletRequest request) {
		System.out.println("Recibiendo objeto pelicula: " + pelicula.getId());
		...
		System.out.println(new Date() + " [Insertando...] " + pelicula.getDetalle().getId());

		serviceDetalle.insertar(pelicula.getDetalle());

		System.out.println(new Date() + " [Insertando...] " + pelicula.getId());

		servicePelicula.insertar(pelicula);

		redirectAttibute.addFlashAttribute("mensaje", "Registro insertado correctamente");
		// return "peliculas/formPelicula";
	...
	public String delete(@PathVariable("id") int idPelicula, RedirectAttributes attributes) {
		...
		// Primero eliminamos la pelicula
		servicePelicula.eliminar(idPelicula);

		// Segundo elliminamos el detalle
		serviceDetalle.eliminar(pelicula.getDetalle().getId());

		attributes.addFlashAttribute("mensaje", "Pelicula con id: " + idPelicula + " eliminada correctamente!");
	...
	public List<String> getGeneros() {
		return serviceGeneros.buscarDetalles();
	}
